const MATERIAL_UTILS_URL = new URL("./vendor/material-color-utilities.esm.js",import.meta.url).href;
...
export async function applyDynamicTheme(config,imageOverride=null,opts={}){
  ...
  const seed=theme.dynamicColor!==false && theme.source==="background"?await extractSeed(image,fallback):fallback;
