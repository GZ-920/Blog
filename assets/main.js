...
function initHeroCarousel(config){
  ...
  const applyThemeFor=i=>{
    ...
    const theme={...config.theme,background:{...config.theme?.background,image:target}};
    if(manual){theme.seedColor=manual;theme.source="manual";theme.dynamicColor=true;}
    else theme.source="background";
