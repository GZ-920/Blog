const CACHE='chuyuan-blog-m3-v20';
const CORE=[
  './assets/style.css',
  './assets/main.js',
  './assets/article.js',
...
self.addEventListener('fetch',event=>{
  ...
  const networkFirst=url.pathname.includes('/posts/') || url.pathname.endsWith('/site.config.json') || url.pathname.endsWith('/admin.js') || url.pathname.endsWith('/shared.js') || url.pathname.endsWith('/theme-engine.js');
  if(networkFirst){
    event.respondWith(
